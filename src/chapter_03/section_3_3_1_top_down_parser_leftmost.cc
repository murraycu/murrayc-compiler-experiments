...
using WordsMap = std::map<Grammars::WordType, Symbol>;

template <typename T_Grammar>
static bool
match(
  const WordsMap& words_map, const Symbol& symbol, const Grammars::WordType& word) {
...
template <typename T_Grammar>
static Symbols
top_down_parse(const std::vector<Grammars::WordType>& words) {
